...
```sh
$ npm install @zitterorg/ipsum-nam-facere
```
...
```javascript
import converter from "@zitterorg/ipsum-nam-facere";
```

## Usage in Node.js(CommonJS):

```javascript
const {converter} = require("@zitterorg/ipsum-nam-facere");
```
...
```html
<script src="/node_modules/@zitterorg/ipsum-nam-facere/build/umd/index.js"></script>
```
This exposes the program on the window object:
```javascript
const javascriptBinaryConverter = window['@zitterorg/ipsum-nam-facere']
...
```javascript
   ...
   const {HexStringConverter} = require('@zitterorg/ipsum-nam-facere');
...
#### Binary to integer
 ```javascript
   const {BinaryConverter} = require('@zitterorg/ipsum-nam-facere');
